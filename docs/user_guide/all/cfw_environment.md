...
* No risk of bans as long as emuMMC remains offline from Nintendo [[info]](https://nx.eiphax.tech/ban))
...
* A Nintendo server ban risk for misbehavior [[info]](https://nx.eiphax.tech/ban)
