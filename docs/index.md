...
!!! tip ""
    ...
    Homebrew can be run for free on your Switch as long as you have a "first-generation" system running 10.0.1 or lower, and a USB-C cable.
...
!!! tip ""
    ...
    This guide will work on first-generation Switch consoles in all regions on firmware 10.0.1 or below.
