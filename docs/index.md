...
Because of this, there is a large likelihood of (potentially dangerous) Atmosphère forks that will spawn because of this. Users are advised **not** to use these forks, and should wait for proper Atmosphère updates from developers who know what they're doing.
