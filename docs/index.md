...
!!! tip ""
    ...
    Homebrew can be run for free on your Switch through Custom Firmware as long as you have a "first-generation" system running 14.1.0 or lower, and a USB-C cable.
...
!!! tip ""
    ...
    This guide will work on first-generation Switch consoles in all regions on firmware 14.1.0 or below.
