...
!!! danger "Issues with latest firmware"
	Version 8.1.0 currently does not boot from Hekate, both Atmosphere and stock firmware. To boot Atmosphere, [please follow these steps](extras/alternate_bootsetups) until Hekate is updated.
