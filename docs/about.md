...
!!! tip "Developer / Tool credits"
    ...
    - **WerWolv** for [EdiZon](https://github.com/WerWolv/EdiZon).
    ...
    - **shchmue** for [Lockpick_RCM](https://vps.suchmeme.nl/git/mudkip/Lockpick_RCM).
    ...
    - **exelix11** for [Switch Theme Injector](https://github.com/exelix11/SwitchThemeInjector).
